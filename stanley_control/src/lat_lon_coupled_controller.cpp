...
StanelyAndPIDController::StanelyAndPIDController() : Node("vehicle_control")
{
    ...
    global_path_publish_timer = this->create_wall_timer(500ms, std::bind(&StanelyAndPIDController::GlobalPathPublishCallback, this)); 
...
void StanelyAndPIDController::GlobalPathPublishCallback()
{   
